use crate::render_model::{NodeColors, Rect, RenderNode, RenderSocket};
use crate::ui::NodeUIDefinition;
use std::collections::HashMap;
use wglymr_document::NodeDescriptor;
...
pub fn build_render_node(
    ...
    RenderNode {
        ...
        output_sockets,
        z_index: 0,
        depth_layer: crate::depth::DepthLayer::NodesInactive,
        text_runs: Vec::new(),
    }
}
