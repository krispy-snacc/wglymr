use crate::document::commands::{EdgeId, NodeId};
use crate::editor::draw::DrawItem;
use crate::editor::input::KeyModifiers;
...
impl InteractionResolver {
    ...
    pub fn resolve_mouse_down(
        ...
        let target = hit.map(map_draw_item_to_target).unwrap_or(InteractionTarget::None);
