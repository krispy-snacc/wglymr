...
use crate::commands::{EdgeId, EditorCommand, NodeId, NodePosition, SocketId};
use crate::descriptors::{EdgeDescriptor, NodeDescriptor, SocketDescriptor, SocketDirection};
...
impl Default for TestDocumentAdapter {
    fn default() -> Self {
        Self::new()
    }
}
